...
def scenario_answercheck(request):
	...
	user_answer.append(request.POST.get('answer1', 'blank')
        ...
        user_answer.append(request.POST.get('answer3')
        user_answer.append(request.POST.get('answer4')
        user_answer.append(request.POST.get('answer5')
        user_answer.append(request.POST.get('answer6')
        user_answer.append(request.POST.get('answer7')
        user_answer.append(request.POST.get('answer8')
        user_answer.append(request.POST.get('answer9')
        user_answer.append(request.POST.get('answer10')
        user_answer.append(request.POST.get('answer11')
        user_answer.append(request.POST.get('answer12')
        user_answer.append(request.POST.get('answer13')
        user_answer.append(request.POST.get('answer14')
        user_answer.append(request.POST.get('answer15')
'''	
